    ...
    return (
        <>
            <Link href={workCompProps?.link} onMouseLeave={() => handleAnimeImageLeave()}
                ...
                <div className="w-9/12 flex relative "> <h5 className="text-sm font-medium group-hover:translate-x-4 transition-[transform] duration-300 ease"> {workCompProps.title} </h5>
            ...
            <div className="flex flex-col gap-y-4 lg:hidden   ">
                ...
                <div>
                    {workCompProps.image && (
                        <Image
                            alt={workCompProps.title}
                            src={workCompProps.image}
